...
if(PREDICT_FALSE(mb0->timesync > 500))
		busyloop[cpu_index]+=mb0->timesync -(WEIGHT_DPDK+WEIGHT_IP4E);

if(PREDICT_FALSE(mb1->timesync > 500))
        busyloop[cpu_index]+=mb1->timesync -(WEIGHT_DPDK+WEIGHT_IP4E);

if(PREDICT_FALSE(mb2->timesync > 500))
        busyloop[cpu_index]+=mb2->timesync -(WEIGHT_DPDK+WEIGHT_IP4E);

if(PREDICT_FALSE(mb3->timesync > 500))
        busyloop[cpu_index]+=mb3->timesync -(WEIGHT_DPDK+WEIGHT_IP4E);
////////////////////////////////////////////////////////////
